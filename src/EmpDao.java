...
public class EmpDao {
	...
	public static Connection getConnection(){
		...
		try{
			...
			con=DriverManager.getConnection("jdbc:mysql://localhost:3306/usertable","root","");
	...
	public static int save(Emp e){
		...
		try{
			...
			PreparedStatement ps=con.prepareStatement("insert into usertable(name,password,email,country) values (?,?,?,?)");
